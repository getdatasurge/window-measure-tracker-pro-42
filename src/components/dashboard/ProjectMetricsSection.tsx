  ...
  useEffect(() => {
    ...
    const fetchMetrics = async () => {
      try {
        ...
        const [
          { count: activeProjectsCount, error: activeError },
          { count: upcomingProjectsCount, error: upcomingError },
          { count: measuredCount, error: measuredError },
        ...
        if (activeError || upcomingError || measuredError || pendingError) {
          throw activeError || upcomingError || measuredError || pendingError;
        }
