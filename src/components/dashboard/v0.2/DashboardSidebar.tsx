...
const DashboardSidebar: React.FC<SidebarProps> = ({
  ...
  return <motion.div initial={{
    ...
    duration: 0.2
      ...
      <div className="p-4 flex py-0 px-[11px]">
        ...
        <button onClick={toggleCollapsed} className="p-1.5 h-[2rem] rounded-md bg-zinc-800/50 hover:bg-zinc-700/50 text-zinc-400 hover:text-white transition-colors top-[45%]">
