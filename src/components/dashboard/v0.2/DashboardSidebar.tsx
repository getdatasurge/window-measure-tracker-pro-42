  ...
  return <motion.div initial={{
    ...
    duration: 0.2
      ...
      <div className="p-0 flex shrink-0 h-[10%] items-center">
        ...
        <button onClick={toggleCollapsed} className="p-1.5 h-[2rem]rounded-md bg-zinc-800/50 hover:bg-zinc-700/50 text-zinc-400 hover:text-white transition-colors px-0 py-0 pl-[1rem] rounded-full">
          {collapsed ? <ChevronRight size={16} className="mr-[.75rem]" /> : <ChevronLeft size={16} />}
        </button>
      </div>
