...
const TeamRoleCard: React.FC<TeamRoleCardProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700/50 rounded-lg p-4 sm:p-5 hover:bg-gray-50 dark:hover:bg-zinc-800/70 transition-colors cursor-pointer">
      <div className="flex items-start justify-between">
        <div className="space-y-1 sm:space-y-2">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="font-medium text-xs sm:text-sm text-gray-700 dark:text-zinc-200">{title}</h3>
          </div>
